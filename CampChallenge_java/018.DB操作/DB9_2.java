 ...
 * @author ei-tk
 */
public class DB9_2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String t = request.getParameter("電話番号");
            int a = Integer.parseInt(request.getParameter("年齢"));
            String b = request.getParameter("誕生日");
            ...
            db_st1 = db_con.prepareStatement("insert into profiles(profilesID, name, tel, age, birthday)  value(?, ?, ?, ?, ?)");
            db_st1.setInt(1, id);
            db_st1.setString(2, n);
            db_st1.setString(3, t);
            db_st1.setInt(4, a);
            db_st1.setString(5, b);
