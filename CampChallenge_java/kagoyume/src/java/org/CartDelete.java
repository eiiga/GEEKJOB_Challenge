    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            ArrayList<SearchData> cartitem = (ArrayList<SearchData>)session.getAttribute("cartitem");
                cartitem.remove(cartnum);
            ArrayList<SearchData> itemcode = (ArrayList<SearchData>)session.getAttribute("item");
                itemcode.remove(cartnum);
                
            session.setAttribute("cartitem", cartitem);
            session.setAttribute("item", itemcode);
