<%-- 
    ...
    Created on : 2017/10/31, 15:18:04
    Author     : ei-tk
--%>
...
<html>
    ...
    <body>
        ...
        上記の内容で登録します。よろしいですか？
        <br>
        <form action="http://localhost:8080/kagoyume/RegistrationComplete" method="POST"  class="col-xs-4 col-xs-offset-4 form-group" >

            <input type="submit" name="yes"  class="center-block btn btn-primary  btn-sm" value="はい">
        </form>
        <form action="registration.jsp" method="POST" class="col-xs-4 col-xs-offset-4 form-group" >

            <input type="submit" name="no"  class="center-block btn btn-primary  btn-sm" value="いいえ">
        </form>
        <br>
         <div  class="col-xs-4 col-xs-offset-4" >
