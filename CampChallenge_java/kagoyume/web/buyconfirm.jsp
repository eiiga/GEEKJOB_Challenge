<%-- 
    Document   : buyconfirm
    Created on : 2017/11/06, 14:25:43
    Author     : ei-tk
--%>
...
<html>
    ...
    <br><br><br>
        ...
        <form action="BuyComplete" method="POST"  class="col-xs-4 col-xs-offset-4 form-group" >
            発送方法<br>
            Y社：<input type="radio" name="transport" value="1" class="radio"  checked><br>
            S社：<input type="radio" name="transport" value="2" class="radio" ><br>
            N社：<input type="radio" name="transport" value="3" class="radio" ><br>
            JP社：<input type="radio" name="transport" value="4" class="radio" ><br>
            <br><br>
            <input type="submit" name="submit" class="center-block btn btn-primary  btn-sm" value="上記の内容で購入する">
        <%}%>
        </form>
