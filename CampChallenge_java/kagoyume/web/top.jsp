<%-- 
    Document   : top
    Created on : 2017/10/24, 11:27:35
    Author     : ei-tk
--%>
...
<html>
    ...
    <body>
        ...
        さん</p>
        <a href="http://localhost:8080/kagoyume/Logout?data=<%= dto.getName() %>"  style="position: absolute; right: 20px; top: 60px">ログアウト</a><br>
        ...
        <form action="http://localhost:8080/kagoyume/search" method="GET" class="col-xs-4 col-xs-offset-4 form-group">
          
            <input type="text" name="search" value="" class="center-block form-control" required>
            <input type="submit" name="searching"  class="center-block btn btn-primary  btn-sm" value="検索">
